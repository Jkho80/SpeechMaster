  ...
  methods: {
    ...
    async fetchSentence() {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/index/PracticeAim/PracticeAim.vue:79", "Fetch Sentence Response:", res);
        if (res.statusCode === 200) {
          this.sentence = res.data.message;
          this.sentenceLines = this.sentence.split("\n");
          this.asrResponseLines = this.sentenceLines.map(() => "");
        } else {
          common_vendor.index.__f__("error", "at pages/index/PracticeAim/PracticeAim.vue:85", "Failed to fetch sentence:", res.statusCode, res.data);
        }
      } catch (error) {
        common_vendor.index.__f__("error", "at pages/index/PracticeAim/PracticeAim.vue:88", "Error fetching sentence:", error);
        common_vendor.index.__f__("error", "at pages/index/PracticeAim/PracticeAim.vue:89", "Full error object:", JSON.stringify(error, null, 2));
      }
    },
    ...
    async startRecording() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/PracticeAim/PracticeAim.vue:156", "Error starting recording:", error);
      }
    },
    stopRecording() {
    ...
    async sendAudioToASR(audioBlob) {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/index/PracticeAim/PracticeAim.vue:202", "Upload success:", jsonResponse);
        if (jsonResponse.result && jsonResponse.result.length > 0) {
          this.updateASRResponse(jsonResponse.result[0].text);
        }
      } catch (error) {
        common_vendor.index.__f__("error", "at pages/index/PracticeAim/PracticeAim.vue:209", "Error uploading audio:", error);
      }
    },
    ...
    async sendAudioToASR(audioBlob) {
      try {
        ...
        const jsonResponse = await response.json();
        common_vendor.index.__f__("log", "at pages/index/PracticeAim/PracticeAim.vue:267", "Upload success:", jsonResponse);
        if (jsonResponse.result && jsonResponse.result.length > 0) {
          this.updateASRResponse(jsonResponse.result[0].text);
        }
      } catch (error) {
        common_vendor.index.__f__("error", "at pages/index/PracticeAim/PracticeAim.vue:275", "Error uploading audio:", error);
      }
    },
    fileToTempPath(file) {
    ...
    async calculateFinalScore(audioBlob) {
      try {
        ...
        const jsonResponse = await response.json();
        common_vendor.index.__f__("log", "at pages/index/PracticeAim/PracticeAim.vue:333", "Upload success:", jsonResponse);
        this.finalScore = jsonResponse.score;
        this.feedback = jsonResponse.feedback;
      } catch (error) {
        common_vendor.index.__f__("error", "at pages/index/PracticeAim/PracticeAim.vue:337", "Error uploading audio:", error);
      }
    }
  }
};
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b1f85601"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/index/PracticeAim/PracticeAim.js.map
